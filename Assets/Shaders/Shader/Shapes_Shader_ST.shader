	...
	LOD 0
		...
		Pass
		{
			...
			v2f vert ( appdata v )
			{
				...
				float3 temp_output_5_0_g25 = ( ( ase_worldPos - _target ) / _InfluenceRadius );
				float dotResult8_g25 = dot( temp_output_5_0_g25 , temp_output_5_0_g25 );
				float clampResult10_g25 = clamp( dotResult8_g25 , 0.0 , 1.0 );
				float3 temp_output_5_0_g24 = ( ( ase_worldPos - _target2 ) / _InfluenceRadius );
				float dotResult8_g24 = dot( temp_output_5_0_g24 , temp_output_5_0_g24 );
				float clampResult10_g24 = clamp( dotResult8_g24 , 0.0 , 1.0 );
				...
				float3 temp_output_5_0_g23 = ( ( ase_worldPos - _target4 ) / _InfluenceRadius );
				float dotResult8_g23 = dot( temp_output_5_0_g23 , temp_output_5_0_g23 );
				float clampResult10_g23 = clamp( dotResult8_g23 , 0.0 , 1.0 );
				#ifdef _TARGETMODE_ON
				float staticSwitch161 = ( ( ( 1.0 - pow( clampResult10_g25 , 0.5 ) ) * _Activate_Target ) + ( ( 1.0 - pow( clampResult10_g24 , 0.5 ) ) * _Activate_Target_2 ) + ( _Activate_Target_3 * ( 1.0 - pow( clampResult10_g22 , 0.5 ) ) ) + ( _Activate_Target_4 * ( 1.0 - pow( clampResult10_g23 , 0.5 ) ) ) );
				#else
...
/*ASEBEGIN
Version=17500
-1920;-14;1920;1019;-2565.484;-95.40842;1.096752;True;True
...
Node;AmplifyShaderEditor.FunctionNode;153;-1091.889,1200.756;Inherit;False;SphereMask;-1;;25;988803ee12caf5f4690caee3c8c4a5bb;0;3;15;FLOAT3;0,0,0;False;14;FLOAT;5;False;12;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;179;-1085.658,2082.301;Inherit;False;SphereMask;-1;;23;988803ee12caf5f4690caee3c8c4a5bb;0;3;15;FLOAT3;0,0,0;False;14;FLOAT;5;False;12;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;165;-1114.517,1563.984;Inherit;False;SphereMask;-1;;24;988803ee12caf5f4690caee3c8c4a5bb;0;3;15;FLOAT3;0,0,0;False;14;FLOAT;5;False;12;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;75;-1024.028,181.4201;Float;False;Property;_PannerX;PannerX;14;0;Create;True;0;0;False;0;1;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-1022.028,372.4201;Float;False;Property;_PannerY;PannerY;13;0;Create;True;0;0;False;0;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1192.09,499.8668;Float;False;Property;_Animation_speed;Animation Speed;1;0;Create;False;0;0;False;0;1;0;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;7;-833.0626,506.0772;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;141;3264.794,265.2806;Float;False;Property;_ExtrudeUpFaces;ExtrudeUpFaces;21;0;Create;True;0;0;False;0;0;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;158;4033.704,242.588;Float;False;True;-1;2;ShapeFxPackUI;0;1;Shapes_Shader_Pack;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;0;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;True;False;True;2;False;-1;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;False;-1;True;0;False;-1;True;False;0;False;-1;0;False;-1;True;1;RenderType=Opaque=RenderType;True;2;0;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;False;;0
...
ASEEND*/
//CHKSM=F73F6FBE45652F3D31B521BFE42D16B19E18F4CB