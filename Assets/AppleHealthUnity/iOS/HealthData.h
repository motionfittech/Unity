...
+ (NSString *)XMLFromStatisticsCollection:(HKStatisticsCollection *)collection datatype:(HKQuantityType *)sampleType error:(NSError *)error; /*!< @brief generate XML from an HKStatisticsCollection */
