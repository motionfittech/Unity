...
namespace ChartAndGraph
{
    public partial class GraphChart : GraphChartBase, ICanvas
    {
        ...
        void CenterObject(GameObject obj,RectTransform parent)
        {
        ...
        public override void InternalGenerateChart()
        {
            ...
            foreach (GraphData.CategoryData data in ((IInternalGraphData)Data).Categories)
            {
                ...
                {
                    CanvasLines fill = CreateDataObject(data, mask,true);
                ...
                {
                    CanvasLines lines = CreateDataObject(data, mask,true);
                ...
                //{
                CanvasLines dots = CreateDataObject(data, mask, false);
