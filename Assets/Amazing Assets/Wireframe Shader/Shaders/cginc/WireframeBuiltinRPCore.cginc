...
{
	float value = 1 - WireframeShaderReadTriangleMassFromUV(mass, _WireframeShader_Thickness, _WireframeShader_Smoothness, _WireframeShader_Diameter);
...
inline float WireframeShaderCalculateDynamicMask(float3 maskPos)
{
		...
		return 1 - WireframeShaderMaskPlane(_WireframeShaderMaskPlanePosition, _WireframeShaderMaskPlaneNormal, maskPos, _Wireframe_DynamicMaskEdgeSmooth, _Wireframe_DynamicMaskInvert);

	#elif defined(WIREFRAME_DYNAMIC_MASK_SPHERE)

		return 1 - WireframeShaderMaskSphere(_WireframeShaderMaskSpherePosition, _WireframeShaderMaskSphereRadius, maskPos, _Wireframe_DynamicMaskEdgeSmooth, _Wireframe_DynamicMaskInvert);

	#elif defined(WIREFRAME_DYNAMIC_MASK_BOX)

		return 1 - WireframeShaderMaskBox(_WireframeShaderMaskBoxMatrixTRS, _WireframeShaderMaskBoxBoundingBox, maskPos, _Wireframe_DynamicMaskEdgeSmooth, _Wireframe_DynamicMaskInvert);
