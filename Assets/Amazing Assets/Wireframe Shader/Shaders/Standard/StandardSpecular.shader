Shader "Hidden/Amazing Assets/Wireframe Shader/Standard (Specular setup)"
{
    Properties
    {
...
//Wireframe//////////////////////////////////////////////////////////////////
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //NOT SUPPORED BY WIREFRAME SHADER #pragma shader_feature_local _PARALLAXMAP
...
#pragma shader_feature_local WIREFRAME_DYNAMIC_MASK_BASE_TEX_ON 
	...
	CustomEditor "AmazingAssets.WireframeShader.Editor.StandardShaderGUI"
}
